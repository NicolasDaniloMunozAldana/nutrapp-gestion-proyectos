      ...
      {!isMobile && (
        <aside
          style={{
            ...
            alignItems: 'center',
            padding: '24px 0',
            borderRight: `1px solid ${trackingTokens.brand.primaryHover}`,
            position: 'sticky',
            top: 0,
            height: '100vh',
            flex: 'none',
            ...
            {!isMobile && (active === 'dashboard' ? (
              <button
                ...
                style={{
                  ...
                  borderRadius: 12,
                  border: 'none',
                  background: trackingTokens.brand.primary,
                  color: trackingTokens.brand.onPrimary,
                  fontSize: 13,
                  fontWeight: 600,
                  cursor: 'pointer',
                  boxShadow: '0 4px 12px rgba(55,24,81,0.30)',
                  minHeight: 40,
                }}
              >
...
const MobileTab = ({
  ...
  <Link
    ...
    style={{
      ...
      borderRadius: 10,
      textDecoration: 'none',
      color: active ? trackingTokens.brand.primary : '#64748B',
      background: active ? trackingTokens.brand.primarySoft : 'transparent',
      fontSize: 11,
      fontWeight: 600,
      minHeight: 48,
    }}
